...
public class DatabaseResource {
    ...
    private void initMatrixCompetencias() {
        ...
        competencias.add(new Competencia(area_1, ciclo_i,2,"Convive y participa democráticamente en la búsqueda del bien común"));

        Area area_2 = areaRepository.findByCode(2);
        competencias.add(new Competencia(area_2, ciclo_i,3,"Se desenvuelve de manera autónoma a través de su motricidad"));
        ...
        competencias.add(new Competencia(area_5, ciclo_i,5,"Indaga mediante métodos científicos para construir sus conocimientos"));
        competencias.add(new Competencia(area_5, ciclo_i,6,"Resuelve problemas de cantidad"));
        competencias.add(new Competencia(area_5, ciclo_i,7,"Resuelve problemas de forma, movimiento y localización"));

        /**
         * Area_1
         */
        competencias.add(new Competencia(area_1, ciclo_ii,8,"Construye su identidad"));
        competencias.add(new Competencia(area_1, ciclo_ii,9,"Convive y participa democráticamente en la búsqueda del bien común"));
        competencias.add(new Competencia(area_1, ciclo_ii,10,"Construye su identidad, como persona humana, amada por Dios, digna, libre y trascendente, comprendiendo la doctrina de su propia religión, abierto al diálogo con las que le son cercanas"));
        ...
        competencias.add(new Competencia(area_3, ciclo_ii,15,"Crea proyectos desde los lenguajes artísticos"));
        ...
        competencias.add(new Competencia(area_6, ciclo_ii,17,"Resuelve problemas de cantidad"));
        competencias.add(new Competencia(area_6, ciclo_ii,18,"Resuelve problemas de forma, movimiento y localización"));

        /**
         * Area_7
         */
        Area area_7 = areaRepository.findByCode(7);
        competencias.add(new Competencia(area_7, ciclo_ii,19,"Indaga mediante métodos científicos para construir sus conocimientos"));
        ...
        competencias.add(new Competencia(area_9,24,"Se comunica oralmente",
    ...
    private void initMatrixCapacidad() {
        ...
        capacidades.add(new Capacidad(comp_1, "Se valora a sí mismo"));
        capacidades.add(new Capacidad(comp_1, "Autoregula sus emociones"));

        Competencia comp_2 = competenciaRepository.findByCode(2);
        capacidades.add(new Capacidad(comp_2, "Interactúa con todas las personas"));
        capacidades.add(new Capacidad(comp_2, "Construye normas, y asume acuerdos y leyes"));
        capacidades.add(new Capacidad(comp_2, "Participa en acciones que promueven el bienestar común"));

        Competencia comp_3 = competenciaRepository.findByCode(3);
        capacidades.add(new Capacidad(comp_3, "Comprende su cuerpo"));
        capacidades.add(new Capacidad(comp_3, "Se expresa corporalmente"));

        Competencia comp_4 = competenciaRepository.findByCode(4);
        capacidades.add(new Capacidad(comp_4, "Obtiene información del texto oral"));
        capacidades.add(new Capacidad(comp_4, "Infiere e interpreta información del texto oral"));
        capacidades.add(new Capacidad(comp_4, "Adecúa, organiza y desarrolla el texto de forma coherente y cohesionada"));
        capacidades.add(new Capacidad(comp_4, "Utiliza recursos no verbales y paraverbales de forma estratégica"));
        capacidades.add(new Capacidad(comp_4, "Interactúa estratégicamente con distintos interlocutores"));
        capacidades.add(new Capacidad(comp_4, "Reflexiona y evalúa la forma, el contenido y contexto del texto oral"));

        Competencia comp_5 = competenciaRepository.findByCode(5);
        capacidades.add(new Capacidad(comp_5, "Genera y registra datos o información"));

        Competencia comp_6 = competenciaRepository.findByCode(6);
        capacidades.add(new Capacidad(comp_6, "Traduce cantidades a expresiones numéricas"));
        capacidades.add(new Capacidad(comp_6, "Comunica su comprensión sobre los números y las operaciones"));
        capacidades.add(new Capacidad(comp_6, "Usa estrategias y procedimientos de estimación y cálculo"));

        Competencia comp_7 = competenciaRepository.findByCode(7);
        capacidades.add(new Capacidad(comp_7, "Modela objetos con formas geométricas y sus transformaciones"));
        capacidades.add(new Capacidad(comp_7, "Comunica su comprensión sobre las formas y relaciones geométricas"));
        capacidades.add(new Capacidad(comp_7, "Usa estrategias y procedimientos para orientarse en el espacio"));



        Competencia comp_8 = competenciaRepository.findByCode(8);
        capacidades.add(new Capacidad(comp_8, "Se valora a sí mismo"));
        capacidades.add(new Capacidad(comp_8, "Autoregula sus emociones"));

        Competencia comp_9 = competenciaRepository.findByCode(9);
        capacidades.add(new Capacidad(comp_9, "Interactúa con todas las personas"));
        capacidades.add(new Capacidad(comp_9, "Construye normas, y asume acuerdos y leyes"));
        capacidades.add(new Capacidad(comp_9, "Participa en acciones que promueven el bienestar común"));


        Competencia comp_10 = competenciaRepository.findByCode(10);
        capacidades.add(new Capacidad(comp_10, "Conoce a Dios y asume su identidad religiosa y espiritual como persona digna, libre y trascendente"));
        capacidades.add(new Capacidad(comp_10, "Cultiva y valora las manifestaciones religiosas de su entorno argumentando su fe de manera comprensible y respetuosa"));

        Competencia comp_11 = competenciaRepository.findByCode(11);
        capacidades.add(new Capacidad(comp_11, "Comprende su cuerpo"));
        capacidades.add(new Capacidad(comp_11, "Se expresa corporalmente"));

        Competencia comp_12 = competenciaRepository.findByCode(12);
        capacidades.add(new Capacidad(comp_12, "Obtiene información del texto oral"));
        capacidades.add(new Capacidad(comp_12, "Infiere e interpreta información del texto oral"));
        capacidades.add(new Capacidad(comp_12, "Adecúa, organiza y desarrolla el texto de forma coherente y cohesionada"));
        capacidades.add(new Capacidad(comp_12, "Utiliza recursos no verbales y paraverbales de forma estratégica"));
        capacidades.add(new Capacidad(comp_12, "Interactúa estratégicamente con distintos interlocutores"));
        capacidades.add(new Capacidad(comp_12, "Reflexiona y evalúa la forma, el contenido y contexto del texto oral"));

        Competencia comp_13 = competenciaRepository.findByCode(13);
        capacidades.add(new Capacidad(comp_13, "Obtiene información del texto escrito"));
        capacidades.add(new Capacidad(comp_13, "Infiere e interpreta información del texto escrito"));
        capacidades.add(new Capacidad(comp_13, "Reflexiona y evalúa la forma, el contenido y contexto del texto escrito"));

        Competencia comp_14 = competenciaRepository.findByCode(14);
        capacidades.add(new Capacidad(comp_14, "Adecúa el texto a la situación comunicativa"));
        capacidades.add(new Capacidad(comp_14, "Organiza y desarrolla las ideas de forma coherente y cohesionada"));
        capacidades.add(new Capacidad(comp_14, "Utiliza convenciones del lenguaje escrito de forma pertinente"));
        capacidades.add(new Capacidad(comp_14, "Reflexiona y evalúa la forma, el contenido y contexto del texto escrito"));

        Competencia comp_15 = competenciaRepository.findByCode(15);
        capacidades.add(new Capacidad(comp_15, "Explora y experimenta los lenguajes del arte"));
        capacidades.add(new Capacidad(comp_15, "Aplica procesos creativos"));
        capacidades.add(new Capacidad(comp_15, "Socializa sus procesos y proyectos"));

        Competencia comp_16 = competenciaRepository.findByCode(16);
        capacidades.add(new Capacidad(comp_16, "Obtiene información del texto oral"));
        capacidades.add(new Capacidad(comp_16, "Infiere e interpreta información del texto oral"));
        capacidades.add(new Capacidad(comp_16, "Adecúa, organiza y desarrolla el texto de forma coherente y cohesionada"));
        capacidades.add(new Capacidad(comp_16, "Utiliza recursos no verbales y paraverba les de forma estratégica"));
        capacidades.add(new Capacidad(comp_16, "Interactúa estratégicamente con distintos interlocutores"));
        capacidades.add(new Capacidad(comp_16, "Reflexiona y evalúa la forma, el contenido y contexto del texto oral"));

        Competencia comp_17 = competenciaRepository.findByCode(17);
        capacidades.add(new Capacidad(comp_17, "Traduce cantidades a expresiones numéricas"));
        capacidades.add(new Capacidad(comp_17, "Comunica su comprensión sobre los números y las operaciones"));
        capacidades.add(new Capacidad(comp_17, "Usa estrategias y procedimientos de estimación y cálculo"));

        Competencia comp_18 = competenciaRepository.findByCode(18);
        capacidades.add(new Capacidad(comp_18, "Modela objetos con formas geométricas y sus transformaciones"));
        capacidades.add(new Capacidad(comp_18, "Comunica su comprensión sobre las formas y relaciones geométricas"));
        capacidades.add(new Capacidad(comp_18, "Usa estrategias y procedimientos para orientarse en el espacio"));

        Competencia comp_19 = competenciaRepository.findByCode(19);
        capacidades.add(new Capacidad(comp_19, "Problematiza situaciones para hacer indagación"));
        capacidades.add(new Capacidad(comp_19, "Diseña estrategias para hacer indagación"));
        ...
        capacidades.add(new Capacidad(comp_20, "Traduce cantidades a expresiones numéricas",
        ...
        capacidades.add(new Capacidad(comp_20, "Comunica su comprensión sobre los números y las operaciones",
        ...
        capacidades.add(new Capacidad(comp_20, "Usa estrategias y procedimientos de estimación y cálculo",
        ...
        capacidades.add(new Capacidad(comp_20, "Argumenta afirmaciones sobre las relaciones numéricas y las operaciones",
        ...
        capacidades.add(new Capacidad(comp_21, "Traduce datos y condiciones a expresiones algebraicas",
        ...
        capacidades.add(new Capacidad(comp_21, "Comunica su comprensión sobre las relaciones algebraicas",
        ...
        capacidades.add(new Capacidad(comp_21, "Usa estrategias y procedimientos para encontrar reglas generales",
        ...
        capacidades.add(new Capacidad(comp_21, "Argumenta afirmaciones sobre relaciones de cambio y equivalencia",
        ...
        capacidades.add(new Capacidad(comp_22, "Modela objetos con formas geométricas y sus transformaciones",
        ...
        capacidades.add(new Capacidad(comp_22, "Comunica su comprensión sobre las formas y relaciones geométricas",
        ...
        capacidades.add(new Capacidad(comp_22, "Usa estrategias y procedimientos para orientarse en el espacio",
                "Es seleccionar, adaptar, combinar o crear, una variedad de estrategias, " +
        ...
        capacidades.add(new Capacidad(comp_22, "Argumenta afirmaciones sobre relaciones geométricas",
        ...
        capacidades.add(new Capacidad(comp_23, "Representa datos con gráficos y medidas estadísticas o probabilísticas",
        ...
        capacidades.add(new Capacidad(comp_23, "Comunica la comprensión de los conceptos estadísticos y probabilísticos",
        ...
        capacidades.add(new Capacidad(comp_23, "Usa estrategias y procedimientos para recopilar y procesar datos",
        ...
        capacidades.add(new Capacidad(comp_23, "Sustenta conclusiones o decisiones en base a información obtenida",
        ...
        capacidades.add(new Capacidad(comp_24, "Obtiene información del texto oral",
                "El estudiante recupera y extrae información explícita " +
                        "expresada por los interlocutores."));
        capacidades.add(new Capacidad(comp_24, "Infiere e interpreta información del texto oral",
        ...
        capacidades.add(new Capacidad(comp_24, "Adecúa, organiza y desarrolla las ideas de forma coherente y cohesionada",
                "El estudiante " +
        ...
        capacidades.add(new Capacidad(comp_24, "Utiliza recursos no verbales y paraverbales de forma estratégica",
        ...
        capacidades.add(new Capacidad(comp_24, "Interactúa estratégicamente con distintos interlocutores",
        ...
        capacidades.add(new Capacidad(comp_24, "Reflexiona y evalúa la forma, el contenido y contexto del texto oral",
                "Los procesos de " +
        ...
        capacidades.add(new Capacidad(comp_25, "Obtiene información del texto escrito",
                "El estudiante localiza y selecciona " +
                        "información explícita en textos escritos con un propósito específico."));
        capacidades.add(new Capacidad(comp_25, "Infiere e interpreta información del texto",
                "El estudiante construye el sentido " +
                        ...
                        "texto."));
        capacidades.add(new Capacidad(comp_25, "Reflexiona y evalúa la forma, el contenido y contexto del texto",
        ...
        capacidades.add(new Capacidad(comp_26, "Adecúa el texto a la situación comunicativa",
        ...
        capacidades.add(new Capacidad(comp_26, "Organiza y desarrolla las ideas de forma coherente y cohesionada",
                "El " +
        ...
        capacidades.add(new Capacidad(comp_26, "Utiliza convenciones del lenguaje escrito de forma pertinente",
        ...
        capacidades.add(new Capacidad(comp_26, "Reflexiona y evalúa la forma, el contenido y contexto del texto escrito",
        ...
        capacidades.add(new Capacidad(comp_27, "Obtiene información del texto oral en inglés",
                "El estudiante recupera y extrae información explícita " +
                        "expresada por los interlocutores."));
        capacidades.add(new Capacidad(comp_27, "Infiere e interpreta información del texto oral en inglés",
                "El estudiante construye el sentido del texto. " +
        ...
        capacidades.add(new Capacidad(comp_27, "Adecúa, organiza y desarrolla el texto en inglés de forma coherente y cohesionada",
                "El estudiante " +
        ...
        capacidades.add(new Capacidad(comp_27, "Utiliza recursos no verbales y paraverbales de forma estratégica",
        ...
        capacidades.add(new Capacidad(comp_27, "Interactúa estratégicamente en inglés con distintos interlocutores",
                "El estudiante intercambia los " +
        ...
        capacidades.add(new Capacidad(comp_27, "Reflexiona y evalúa la forma, el contenido y contexto del texto oral en inglés",
                "Los procesos de " +
        ...
        capacidades.add(new Capacidad(comp_28, "Obtiene información del texto escrito en inglés",
                "El estudiante localiza y selecciona " +
                        "información explícita en textos escritos con un propósito específico."));
        capacidades.add(new Capacidad(comp_28, "Infiere e interpreta información del texto escrito en inglés",
        ...
        capacidades.add(new Capacidad(comp_28, "Reflexiona y evalúa la forma, el contenido y contexto del texto escrito en inglés",
                "Los procesos de reflexión y evaluación están relacionados porque ambos suponen que el " +
        ...
        capacidades.add(new Capacidad(comp_29, "Adecúa el texto en inglés a la situación comunicativa",
        ...
        capacidades.add(new Capacidad(comp_29, "Organiza y desarrolla las ideas en inglés de forma coherente y cohesionada",
                "El estudiante " +
        ...
        capacidades.add(new Capacidad(comp_29, "Utiliza convenciones del lenguaje escrito en inglés de forma pertinente",
                "El estudiante usa " +
        ...
        capacidades.add(new Capacidad(comp_29, "Reflexiona y evalúa la forma, el contenido y contexto del texto escrito en inglés",
        ...
        capacidades.add(new Capacidad(comp_30, "Se valora a sí mismo",
        ...
        capacidades.add(new Capacidad(comp_30, "Autorregula sus emociones",
        ...
        capacidades.add(new Capacidad(comp_30, "Reflexiona y argumenta éticamente",
                "Es que el estudiante analice situaciones cotidianas para " +
                        ...
                        "en los demás."));
        capacidades.add(new Capacidad(comp_30, "Vive su sexualidad de manera plena y responsable",
        ...
        capacidades.add(new Capacidad(comp_31, "Interactúa con todas las personas",
        ...
        capacidades.add(new Capacidad(comp_31, "Construye normas y asume acuerdos y leyes",
                "Es que el estudiante participe en la " +
                        ...
                        "lo público)."));
        capacidades.add(new Capacidad(comp_31, "Maneja conflictos de manera constructiva",
        ...
        capacidades.add(new Capacidad(comp_31, "Delibera sobre asuntos públicos",
                "Es que participe en un proceso de reflexión y diálogo sobre " +
                        ...
                        "posiciones."));
        capacidades.add(new Capacidad(comp_31, "Participa en acciones que promueven el bienestar común",
        ...
        capacidades.add(new Capacidad(comp_32, "Interpreta críticamente fuentes diversas",
        ...
        capacidades.add(new Capacidad(comp_32, "Comprende el tiempo histórico",
        ...
        capacidades.add(new Capacidad(comp_32, "Elabora explicaciones sobre procesos históricos",
        ...
        capacidades.add(new Capacidad(comp_33, "Comprende las relaciones entre los elementos naturales y sociales",
        ...
        capacidades.add(new Capacidad(comp_33, "Maneja fuentes de información para comprender el espacio geográfico",
                "Es usar distintas " +
        ...
        capacidades.add(new Capacidad(comp_33, "Genera acciones para preservar el ambiente",
        ...
        capacidades.add(new Capacidad(comp_34, "Comprende el funcionamiento del sistema económico y financiero",
        ...
        capacidades.add(new Capacidad(comp_34, "Toma decisiones económicas y financieras",
        ...
        capacidades.add(new Capacidad(comp_35, "Percibe manifestaciones artístico-culturales",
        ...
        capacidades.add(new Capacidad(comp_35, "Contextualiza las manifestaciones culturales",
        ...
        capacidades.add(new Capacidad(comp_35, "Reflexiona creativa y críticamente",
        ...
        capacidades.add(new Capacidad(comp_36, "Explora y experimenta los lenguajes del arte",
                "Significa experimentar, improvisar y desarrollar " +
                        ...
                        "lenguajes del arte."));
        capacidades.add(new Capacidad(comp_36, "Aplica procesos creativos",
        ...
        capacidades.add(new Capacidad(comp_36, "Evalúa y socializa sus procesos y proyectos",
        ...
        capacidades.add(new Capacidad(comp_37, "Problematiza situaciones para hacer indagación",
                "Es plantear preguntas " +
                        "sobre hechos y fenómenos naturales, interpretar situaciones y formular " +
                        "hipótesis."));
        capacidades.add(new Capacidad(comp_37, "Diseña estrategias para hacer indagación",
        ...
        capacidades.add(new Capacidad(comp_37, "Genera y registra datos o información",
        ...
        capacidades.add(new Capacidad(comp_37, "Analiza datos e información",
        ...
        capacidades.add(new Capacidad(comp_37, "Evalúa y comunica el proceso y resultados de su indagación",
                "Es identificar " +
        ...
        capacidades.add(new Capacidad(comp_38, "Comprende y usa conocimientos sobre los seres vivos, materia y energía, biodiversidad, Tierra y universo",
        ...
        capacidades.add(new Capacidad(comp_38, "Evalúa las implicancias del saber y del quehacer científico y tecnológico",
        ...
        capacidades.add(new Capacidad(comp_39, "Determina una alternativa de solución tecnológica",
        ...
        capacidades.add(new Capacidad(comp_39, "Diseña la alternativa de solución tecnológica",
        ...
        capacidades.add(new Capacidad(comp_39, "Implementa la alternativa de solución tecnológica",
                "Es llevar a cabo la " +
        ...
        capacidades.add(new Capacidad(comp_39, "Evalúa y comunica el funcionamiento de su alternativa de solución tecnológica",
        ...
        capacidades.add(new Capacidad(comp_40, "Comprende su cuerpo",
        ...
        capacidades.add(new Capacidad(comp_40, "Se expresa corporalmente",
        ...
        capacidades.add(new Capacidad(comp_41, "Comprende las relaciones entre la actividad física, alimentación, postura e higiene corporal y la salud",
                "Es analizar y comprender los procesos vinculados con la " +
                        ...
                        "entorno."));
        capacidades.add(new Capacidad(comp_41, "Incorpora prácticas que mejoran su calidad de vida",
        ...
        capacidades.add(new Capacidad(comp_42, "Se relaciona utilizando sus habilidades sociomotrices",
        ...
        capacidades.add(new Capacidad(comp_42, "Crea y aplica estrategias y tácticas de juego",
...
//                ""));
        ...
        capacidades.add(new Capacidad(comp_45, "Obtiene información del texto oral",
                "El estudiante recupera y extrae información explícita expresada " +
                        "por los interlocutores."));
        capacidades.add(new Capacidad(comp_45, "Infiere e interpreta información del texto oral",
                "El estudiante construye el sentido del texto. Para ello, " +
                        ...
                        "sociocultural."));
        capacidades.add(new Capacidad(comp_45, "Adecúa, organiza y desarrolla el texto de forma coherente y cohesionada",
        ...
        capacidades.add(new Capacidad(comp_45, "Utiliza recursos no verbales y paraverbales de forma estratégica",
                "El estudiante emplea variados " +
        ...
        capacidades.add(new Capacidad(comp_45, "Interactúa estratégicamente con distintos interlocutores",
        ...
        capacidades.add(new Capacidad(comp_45, "Reflexiona y evalúa la forma, el contenido y contexto del texto oral",
        ...
        capacidades.add(new Capacidad(comp_46, "Obtiene información del texto escrito",
                "El estudiante localiza y selecciona " +
                        "información explícita en textos escritos con un propósito específico."));
        capacidades.add(new Capacidad(comp_46, "Infiere e interpreta información del texto",
                "El estudiante construye el sentido " +
                        "del texto. Para ello, infiere estableciendo diversas relaciones entre la " +
                        "información explícita e implícita con el fin de deducir nueva información y " +
                        "completar los vacíos del texto. A partir de estas inferencias, el estudiante " +
                        ...
                        "de los textos así como su relación con el contexto sociocultural del lector y del " +
                        "texto."));
        capacidades.add(new Capacidad(comp_46, "Reflexiona y evalúa la forma, el contenido y contexto del texto",
                "Los procesos de reflexión y evaluación están relacionados porque ambos suponen que el " +
                        "estudiante se distancie de los textos escritos situados en épocas y lugares " +
                        "distintos, y que son presentados en diferentes soportes y formatos. Reflexionar " +
                        "implica comparar y contrastar aspectos formales y de contenido del texto con la " +
        ...
        capacidades.add(new Capacidad(comp_47, "Adecúa el texto a la situación comunicativa",
                "El estudiante considera el " +
                        "propósito, destinatario, tipo de texto, género discursivo y registro que utilizará al " +
                        "escribir los textos, así como los contextos socioculturales que enmarcan la " +
                        "comunicación escrita."));
        capacidades.add(new Capacidad(comp_47, "Organiza y desarrolla las ideas de forma coherente y cohesionada",
                "El estudiante ordena lógicamente las ideas en torno a un tema, ampliándolas y " +
                        "complementándolas, estableciendo relaciones de cohesión entre ellas y utilizando " +
                        "un vocabulario pertinente."));
        capacidades.add(new Capacidad(comp_47, "Utiliza convenciones del lenguaje escrito de forma pertinente",
                "El estudiante usa de forma apropiada recursos textuales para garantizar la claridad, " +
                        "el uso estético del lenguaje y el sentido del texto escrito."));
        capacidades.add(new Capacidad(comp_47, "Reflexiona y evalúa la forma, el contenido y contexto del texto escrito",
                "El estudiante se distancia del texto que ha escrito para revisar de manera " +
                        "permanente el contenido, la coherencia, cohesión y adecuación a la situación " +
                        "comunicativa con la finalidad de mejorarlo. También implica analizar, comparar y " +
                        "contrastar las características de los usos del lenguaje escrito y sus posibilidades, así " +
